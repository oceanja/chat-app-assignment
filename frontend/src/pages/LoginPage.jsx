                ...
                <div className="auth-card">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ textAlign: "right", marginTop: -8, marginBottom: 16 }}>
                            <a style={{ fontSize: 13, color: "var(--accent)", cursor: "pointer" }}>Forgot password?</a>
                        </div>

                        <button className="btn-primary" type="submit" disabled={isLoggingIn}>
                            {isLoggingIn ? <Loader className="w-5 h-5 animate-spin mx-auto" /> : "Sign In →"}
                        </button>
                    </form>

                    <div className="auth-switch">
                        New to Connect? <Link to="/signup">Create account</Link>
                    </div>
                </div>
            </div>
        </div>
